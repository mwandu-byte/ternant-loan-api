...
return [
    ...
    */
    ...
    // Not used by this application: refresh tokens are handled via the custom,
    // DB-backed, revocable RefreshToken model (see App\Services\Auth\AuthService),
    // not jwt-auth's built-in refresh mechanism. JWT_REFRESH_TTL below drives the
    // RefreshToken expiry only. Kept in sync here for consistency.
